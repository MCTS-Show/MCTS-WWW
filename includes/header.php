    		...
    		<div class="collapse navbar-collapse" id="navbarPixo">
    			<ul class="navbar-nav me-auto mb-2 mb-lg-0"></ul>
      			<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        			...
        			<li class="nav-item">
          				<a class="nav-link" href="games.php">Gry</a>
        			</li>
        			<li class="nav-item">
          				<a class="nav-link" href="staffs.php">Zespół</a>
        			</li>
        			<li class="nav-item">
      			...
      			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        			<li class="nav-item">
          				<a href="https://dc.mcts.pl" target="_blank" class="btn btn-custom"><i class="fad"></i> DISCORD</a>
        			</li>
      			</ul>
    		</div>
  		</div>
